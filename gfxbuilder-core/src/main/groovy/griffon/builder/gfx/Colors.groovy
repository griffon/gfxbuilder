...
//         }
    ...
    */
    ...
    static Color getColor(Number value) {
        return instance._getColor(value)
    }

    static Color getColor(Map value) {
        return instance._getColor(value)
    }
    ...
    static Color get(Color color) {
        return instance._getColor(color)
    }

    static Color get(Number value) {
        return instance._getColor(value)
    }

    static Color get(Map value) {
        return instance._getColor(value)
    }
    ...
    static void set(String name, Color color) {
        instance._setColor(name, color)
    }
