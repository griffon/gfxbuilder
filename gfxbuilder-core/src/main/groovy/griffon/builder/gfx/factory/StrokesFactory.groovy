...
import griffon.builder.gfx.nodes.strokes.ComposableStroke
import griffon.builder.gfx.nodes.strokes.ShapeStrokeNode
import griffon.builder.gfx.nodes.strokes.StrokeNode
